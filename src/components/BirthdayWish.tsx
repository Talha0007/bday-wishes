        ...
        <div className="birthday-card text-center scale-in">
          ...
          <div className="space-y-6 text-lg md:text-xl leading-relaxed">
            <p className="font-medium">
              On this beautiful day, I want you to know how truly special you are for me.
            </p>
            <p>
              Your laughter fills my heart with joy, your kindness touches everyone around you, 
              and your friendship is a gift which I treasure every single day.
            </p>
            <p>
